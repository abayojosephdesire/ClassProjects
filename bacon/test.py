...
def test_tiny_acted_together_01():
    # Test case 01 for two actors who acted together, using the tiny.pickle database
    actor1 = 2876
    actor2 = 4724
    assert lab.acted_together(db_tiny, actor1, actor2) is True

def test_tiny_acted_together_02():
    # Test case 02 for two actors who acted together, using the tiny.pickle database
    actor1 = 1532
    actor2 = 2876
    assert lab.acted_together(db_tiny, actor1, actor2) is True
...
def test_tiny_bacon_path_01():
    # Bacon path, tiny database, path length 3
    actor_id = 1640
...
def test_tiny_actor_to_actor_path_01():
    # Actor path, tiny database, length of 3
    actor_1 = 1532
    actor_2 = 1640
    len_expected = 2
